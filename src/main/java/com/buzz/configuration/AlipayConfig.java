...
public class AlipayConfig {
    ...
    public static String notify_url =    "http://aaajyh.free.idcfengye.com/alipayController/notifyUrl";

    //Controller Mapping:得放到服务器上，且使用域名解析 IP
    public static String return_url = "http://aaajyh.free.idcfengye.com/alipayController/returnUrl";
