        ...
        try
        {
            ...
            if(file.exists()) {
                ...
                if (0<travelnotesservice.update_travelNotesContentAndheadlineAndstate_BytravelNotesId(travelNotesId, travelNotesheadline, newfilename,"30d3e6ed-f7b4-43cd-95e5-5ac428f15245")) {
                    ...
                    if (null != user)
                    {
                        List<travelNotes> list=travelnotesservice.find_travelNotes_ByuserId(user.getUserId(),"b45b8bd7-4ce2-407a-9622-3040573f6710");
                        if(null!=list&&0<list.size())
                        {
                            ...
                            for(travelNotes t:list)
                            {
                                ...
                                {
                                    if(travelnotescontent.getType()=="img")
                                    {
                                        imageNum+=1;
                                    }
                                    else if(travelnotescontent.getType()=="h2"||travelnotescontent.getType()=="textarea")
                                    {
