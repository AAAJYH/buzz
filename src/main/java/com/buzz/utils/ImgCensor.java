...
public class ImgCensor {
    ...
    public static String userDefined() {
        ...
        try {
            // 本地文件路径
            String filePath = "C:\\Users\\jyh\\Desktop\\picture\\u=4040016359,1819288430&fm=27&gp=0.jpg";
            ...
            ImgCensor t=new ImgCensor();
            String accessToken = t.getAuth(clientId, clientSecret);
    ...
    public static void main(String[] args) {
        System.out.println("返回结果"+ImgCensor.userDefined());;
    }
}